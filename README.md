...
- `QuExpr(A,B)` representing _A + B_, i.e., the sum of two operators
- `∑(i,A)` representing _∑<sub>i</sub> A_, i.e., an analytical sum over an index (assumed to run over all possible values of _i_).
