...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Base.Broadcast.copyto_nonleaf!),Array{Tuple{OpTerm,Complex{Int}},1},Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1},Tuple{Base.OneTo{Int}},Type{Tuple},Tuple{Base.Broadcast.Extruded{Array{Pair{OpTerm,Union{Complex{Rational{Int}}, Complex{Float64}, Complex{Int}, Rational{Int}, Float64, Int}},1},Tuple{Bool},Tuple{Int}}}},Base.OneTo{Int},Int,Int})
    ...
    Base.precompile(Tuple{typeof(Base.Broadcast.restart_copyto_nonleaf!),Array{Tuple{OpTerm,Number},1},Array{Tuple{OpTerm,Complex{Int}},1},Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1},Tuple{Base.OneTo{Int}},Type{Tuple},Tuple{Base.Broadcast.Extruded{Array{Pair{OpTerm,Union{Complex{Rational{Int}}, Complex{Float64}, Complex{Int}, Rational{Int}, Float64, Int}},1},Tuple{Bool},Tuple{Int}}}},Tuple{OpTerm,Rational{Int}},Int,Base.OneTo{Int},Int,Int})
    ...
    Base.precompile(Tuple{typeof(Base.Order.lt),Base.Order.ForwardOrdering,Tuple{OpTerm,Rational{Int}},Tuple{OpTerm,Complex{Int}}})
    ...
    Base.precompile(Tuple{typeof(Base._copyto_impl!),Array{δ,1},Int,Array{δ,1},Int,Int})
    Base.precompile(Tuple{typeof(Base._delete!),Dict{OpTerm,Union{Complex{Rational{Int}}, Complex{Float64}, Complex{Int}, Rational{Int}, Float64, Int}},Int})
    Base.precompile(Tuple{typeof(Base._deleteat!),Array{BaseOperator,1},Tuple{Int,Int},Base.Nowhere})
    ...
    Base.precompile(Tuple{typeof(QuantumAlgebra.print_term_scalar),IOContext{Base.GenericIOBuffer{Array{UInt8,1}}},OpTerm,Int,Bool})
    Base.precompile(Tuple{typeof(QuantumAlgebra.simplify_number),Int})
    ...
    Base.precompile(Tuple{typeof(copy),Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1},Tuple{Base.OneTo{Int}},typeof(adjoint),Tuple{SubArray{BaseOperator,1,Array{BaseOperator,1},Tuple{StepRange{Int,Int}},true}}}})
    ...
    Base.precompile(Tuple{typeof(hash),NTuple{5,OpIndex},UInt})
    ...
    Base.precompile(Tuple{typeof(setindex!),Array{Tuple{OpTerm,Complex{Int}},1},Tuple{OpTerm,Complex{Int}},Int})
    ...
    Base.precompile(Tuple{typeof(setindex!),Dict{OpTerm,Union{Complex{Rational{Int}}, Complex{Float64}, Complex{Int}, Rational{Int}, Float64, Int}},Complex{Int},OpTerm})
    ...
    Base.precompile(Tuple{typeof(setindex!),Dict{OpTerm,Union{Complex{Rational{Int}}, Complex{Float64}, Complex{Int}, Rational{Int}, Float64, Int}},Float64,OpTerm})
    Base.precompile(Tuple{typeof(setindex!),Dict{OpTerm,Union{Complex{Rational{Int}}, Complex{Float64}, Complex{Int}, Rational{Int}, Float64, Int}},Int,OpTerm})
    Base.precompile(Tuple{typeof(setindex!),Dict{OpTerm,Union{Complex{Rational{Int}}, Complex{Float64}, Complex{Int}, Rational{Int}, Float64, Int}},Rational{Int},OpTerm})
    Base.precompile(Tuple{typeof(similar),Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1},Tuple{Base.OneTo{Int}},Type{Tuple},Tuple{Base.Broadcast.Extruded{Array{Pair{OpTerm,Union{Complex{Rational{Int}}, Complex{Float64}, Complex{Int}, Rational{Int}, Float64, Int}},1},Tuple{Bool},Tuple{Int}}}},Type{Tuple{OpTerm,Complex{Int}}}})
