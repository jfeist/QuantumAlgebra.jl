function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(Base.Sort.sort!)),NamedTuple{(:lt,),Tuple{typeof(QuantumAlgebra.CorrExpTup_isless)}},typeof(sort!),Array{NTuple{4,Int},1}})
    Base.precompile(Tuple{Core.kwftype(typeof(Base.Sort.sort!)),NamedTuple{(:lt,),Tuple{typeof(QuantumAlgebra.CorrExpTup_isless)}},typeof(sort!),Array{Tuple{Int,Int,Int},1}})
